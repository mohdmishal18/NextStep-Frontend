...
const ProfileHeader: React.FC = () => {
  ...
  const [bannerImage, setBannerImage] = useState('https://cdn.builder.io/api/v1/image/assets/TEMP/210d84119455df534826d71fac74b74977de88a05b22ee00c6a99bd49ace1065?apiKey=989d0fe6dce947e78429c931599938be&&apiKey=989d0fe6dce947e78429c931599938be');
  ...
  return (
    <section className="flex flex-col grow mt-20 w-full rounded-xl bg-zinc-900 max-md:mt-10 max-md:max-w-full">
      <div className="flex flex-col rounded-xl bg-zinc-800 max-md:max-w-full">
        <div className="flex relative flex-col items-start px-5 pt-20 w-full rounded-xl min-h-[198px] max-md:pr-5 max-md:max-w-full">
          <img 
            loading="lazy" 
          ...
          <div className="relative z-10 mt-9 w-40 h-40 rounded-full border-[5px] border-zinc-900 object-cover">
            <img
              loading="lazy"
        ...
        <div className="z-10 pt-3 pr-3 pb-8 pl-20 mb-0 rounded-xl bg-zinc-800 max-md:pl-5 max-md:mb-2.5 max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col">
            <div className="flex flex-col w-[84%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow items-start font-light text-sky-50 max-md:mt-10 max-md:max-w-full">
                ...
                <p className="self-stretch mt-5 text-sm leading-3 text-white max-md:max-w-full">
                  As a mentee, I am proactive, open to feedback, and committed to continuous learning. I believe that with the right guidance and support, I can achieve my goal of becoming a proficient full stack developer.
                </p>
              </div>
            </div>
