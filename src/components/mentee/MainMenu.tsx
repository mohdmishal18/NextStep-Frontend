...
const menuItems: MenuItem[] = [
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/bef5b6954ffb0106dd73f64178243252736f50f7e6082ef79a47cfd6d485a4db?apiKey=989d0fe6dce947e78429c931599938be&&apiKey=989d0fe6dce947e78429c931599938be", label: "Dashboard", alt: "Dashboard icon", path: "/mentee" },
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/ae598cf5df2358dbd8251c7e75753a351e21f018976bb3b2d49c69812409e533?apiKey=989d0fe6dce947e78429c931599938be&&apiKey=989d0fe6dce947e78429c931599938be", label: "My Feed", alt: "Feed icon", path: "/mentee/myfeed" },
  ...
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/e594c285702c4194500780d18ea5a75765ad45bcaf593acc1b0b26e39c9b5dbb?apiKey=989d0fe6dce947e78429c931599938be&&apiKey=989d0fe6dce947e78429c931599938be", label: "Search", alt: "Search icon", path: "/mentee/search" },
];
