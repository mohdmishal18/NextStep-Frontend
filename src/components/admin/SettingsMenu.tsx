...
const menuItems: MenuItem[] = [
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/94d9dd513795cf4a3d185685c35392c597409f882ed363acd1901c28514928de?apiKey=989d0fe6dce947e78429c931599938be&&apiKey=989d0fe6dce947e78429c931599938be", label: "Help & Support", alt: "Help icon", route: "/admin" },
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/f1e14347df213b6f8cda42ba472667e1150d0dfe8dd0902af0ad7e0d0740bb4b?apiKey=989d0fe6dce947e78429c931599938be&&apiKey=989d0fe6dce947e78429c931599938be", label: "Settings", alt: "Account icon", route: "/admin/settings"},
];
