...
const MentorApplications: React.FC = () => {
  ...
  const handleApprove = () => {
    ...
    console.log("Approved", currentMentor);
    handleCloseModal();
  };

  const handleReject = () => {
    // Implement reject logic here
    console.log("Rejected", currentMentor);
    handleCloseModal();
  };
            ...
            <>
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p><strong>Approved:</strong> {currentMentor.isApproved ? "Yes" : "No"}</p>
                </div>
