...
const menuItems: MenuItem[] = [
  ...
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/d236d2a6b5308e20e1b913017a7f8a389b11a02d0e72aa0c3aeae2672508da27?apiKey=989d0fe6dce947e78429c931599938be&&apiKey=989d0fe6dce947e78429c931599938be", label: "My Mentees", alt: "Mentors icon", path: "/mentors" },
  ...
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/b5f5b9874de3bc4aa8936d3f86527a3b220310f0574ac7d305bb3649cbd839b1?apiKey=989d0fe6dce947e78429c931599938be&&apiKey=989d0fe6dce947e78429c931599938be", label: "Requests", alt: "Requested mentors icon", path: "/requests" },
